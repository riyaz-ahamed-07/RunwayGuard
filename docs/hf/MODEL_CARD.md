...
```bash
# download
huggingface-cli download DarkKnight1217/RunwayGuard-rtdetr-l best.pt --local-dir ./weights

# or
curl -L -o weights/best.pt https://huggingface.co/DarkKnight1217/RunwayGuard-rtdetr-l/resolve/main/best.pt
```
